...
int DS18x20_TemperatureValue(TSDS18x20 *pDS18x20)
{
	...
	{
		case CONF_RES_10b:
			return sign*(abs(Temperature)/4) * 4;//0.25;
			break;
		case CONF_RES_11b:
			return sign*(abs(Temperature)/2) * 2;// * 0.125;
		case CONF_RES_12b:
			return Temperature;// * 0.0625;
			break;
		case CONF_RES_9b:
			return sign*(abs(Temperature)/8) * 8;//0.5;
			break;
		default:
			return 0;
	}
